...
import { FaTransgenderAlt, FaFemale, FaMale } from "react-icons/fa"; // icons
import { MdLocationOn } from "react-icons/md"; // Location icon
import { GiEarthAmerica } from "react-icons/gi"; // Origin icon
import { Listbox } from "@headlessui/react"; // Listbox from Headless UI
...
export default function Example() {
  ...
  const itemsPerPage = 15; // Number of characters to display per page
      ...
      <div className="mx-auto py-12 px-4 max-w-7xl sm:px-6 lg:px-8 lg:py-24">
        <div className="space-y-12">
          ...
          <Pagination
            ...
            indexOfFirstCharacter={indexOfFirstCharacter} // Add this prop
            indexOfLastCharacter={indexOfLastCharacter} // Add this prop
            filteredCharacters={filteredCharacters} // Add this prop
          />
        </div>
      </div>
    </div>
